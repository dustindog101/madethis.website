...
<header class="toolbar">
  ...
  <div class="toolbar__right">
    <button class="btn" id="speed-btn" type="button" title="Playback speed (S)">
      <span id="speed-label">1×</span>
    </button>
    <button class="btn" id="pip-btn" type="button" title="Picture-in-Picture (P)">
    ...
    <button class="btn" id="fullscreen-btn" type="button" title="Toggle Fullscreen (F)">
...
<div class="embed-popover" id="embed-popover">
  ...
  <div class="embed-group">
    <label class="embed-label">HTML Video Tag</label>
    <div class="embed-row">
      <input class="embed-input" id="embed-html" readonly value='&lt;video src="${safeFullRawUrl}" controls playsinline&gt;&lt;/video&gt;' />
      <button class="btn embed-copy" data-target="embed-html" type="button">Copy</button>
    </div>
  </div>
  <div class="embed-group">
    <label class="embed-label">Markdown Link</label>
    <div class="embed-row">
...
(function() {
  ...
  function toggleFullscreen() {
    if (!document.fullscreenElement) {
      const stage = document.getElementById("video-stage") || video;
